  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Manage your Microgamma account, view your profile information, and access account settings."
        />
      </Head>
              ...
              : (
                <div class="card-glow bg-black/60 backdrop-blur-sm rounded-lg border border-primary-400/30 p-8 text-center">
                  <div class="animate-pulse">
                    <div class="h-8 bg-primary-900/50 rounded w-48 mx-auto mb-4">
                    </div>
                    <div class="h-4 bg-primary-900/30 rounded w-64 mx-auto">
                    </div>
                  </div>
