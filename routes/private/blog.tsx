        ...
        <div class="relative z-10">
          <div class="max-w-6xl mx-auto">
            <div class="card-glow bg-black/60 backdrop-blur-sm rounded-lg border border-primary-400/30 p-8 mb-8">
              ...
              <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                <div class="bg-gray-800/50 p-4 rounded-lg text-center">
                  <div class="text-2xl font-bold text-primary-300">{allPosts.length}</div>
                ...
                <div class="bg-gray-800/50 p-4 rounded-lg text-center">
                  <div class="text-2xl font-bold text-yellow-400">{userDrafts.length}</div>
                  <div class="text-gray-400 text-sm">Drafts</div>
                </div>
                <div class="bg-gray-800/50 p-4 rounded-lg text-center">
                  <div class="text-2xl font-bold text-blue-400">
                    {allPosts.reduce((sum, post) => sum + (post.readingTime || 0), 0)}
                  </div>
            ...
            <div class="card-glow bg-black/60 backdrop-blur-sm rounded-lg border border-primary-400/30 p-8">
              <h2 class="text-xl font-semibold text-primary-400 mb-6">Your Posts</h2>

              {allPosts.length === 0 ? (
                <div class="text-center py-12">
                  <div class="text-6xl mb-4">📝</div>
                  <h3 class="text-xl font-semibold text-gray-300 mb-2">No posts yet</h3>
                  <p class="text-gray-400 mb-6">Create your first blog post to get started</p>
                  <a
                    href="/private/blog/new"
                    ...
                    >
                      <div class="flex justify-between items-start mb-4">
                        ...
                        <div class="flex space-x-2 ml-4">
                          ...
                          <form method="post" action={`/private/blog/${post.id}/delete`} class="inline">
                            <button
                              type="submit"
