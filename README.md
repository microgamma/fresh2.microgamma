...
- **Framework:** [Fresh 2.0](https://fresh.deno.dev) - Modern web framework for
  Deno
- **Runtime:** [Deno 2.0+](https://deno.land) - Secure runtime for
...
- **Accessibility Compliant** - Keyboard navigation, screen reader support, skip
  links
...
- **Profile:** `/private/profile` - Account management (authenticated users
  only)
...
We welcome contributions from the music ownership community! Please see our
contributing guidelines and respect our code of conduct focused on user freedom
and privacy.
